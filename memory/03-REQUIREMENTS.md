...
> **2026-09-10 第十五~十八轮**：近期主线第二项 **#76** 已**全部落地** —— **B1（符号索引数据层，
> 第十五轮）**、**B4（代码内点/选中变量 → 加波形 = 唯一加信号主路径，第十六轮）**、
> **B3（代码 ↔ 树双向跳转 = 代码光标反向高亮 RTL/VCD 树，仿 nTrace「光标即高亮」，第十七轮）**、
> **B5（画布观察行随 `.wp` 工程存档与恢复，第十八轮）**；#76 收口，**下一项 = #87②（模块全接口 Ctrl+4）**。
> 详见 04 §4.13/§4.14/§4.15/§4.16、06 P32/P33/P34/P35、07 D16/D17/D18、08 §1.2。
